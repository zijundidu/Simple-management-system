...
<body>
	...
	<div class="container" id="input">
		<form action="<c:url value='/GoodsServlet' />" method="get">
			<input type="hidden" name="method" value="queryPlus" />
			...
			<div class="input-group">
				<span class="input-group-addon">库存数量</span> <input type="text"
					name="minNum" class="form-control" placeholder="最小库存"
					aria-label="Amount (to the nearest dollar)"> <span
					class="input-group-addon">———</span> <input type="text"
					name="maxNum" class="form-control" placeholder="最大库存"
					aria-label="Amount (to the nearest dollar)">
			</div>

			<div class="input-group">
				<span class="input-group-addon">售价&nbsp;&nbsp;$</span> <input
					type="text" name="minSale" class="form-control" placeholder="最小售价"
					aria-label="Amount (to the nearest dollar)"> <span
					class="input-group-addon">———</span> <input type="text"
					name="maxSale" class="form-control" placeholder="最大售价"
					aria-label="Amount (to the nearest dollar)"><span
					class="input-group-addon">.00</span>
			</div>

			<div class="input-group">
				<span class="input-group-addon">进价&nbsp;&nbsp;$</span> <input
					type="text" name="minPrice" class="form-control" placeholder="最小进价"
					aria-label="Amount (to the nearest dollar)"> <span
					class="input-group-addon">———</span> <input type="text"
					name="maxPrice" class="form-control" placeholder="最大进价"
					aria-label="Amount (to the nearest dollar)"><span
					class="input-group-addon">.00</span>
			</div>
			...
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon3"></span> <input
					type="text" name="param" class="form-control" id="basic-url"
			...
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon3"></span> <input
					type="text" name="remarks" class="form-control" id="basic-url"
					aria-describedby="basic-addon3"> <span
					class="input-group-addon"></span>
			</div>
